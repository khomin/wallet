  ...
  return (
    <div className="flex h-screen bg-[#080a12] text-white">
      ...
      >
        ...
        {/* Demo mode banner */}
        {isDemo && (
          <div className="m-4 p-3 rounded-xl bg-amber-500/10 border border-amber-500/30 ring-1 ring-amber-500/10">
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-amber-500/80">Pre-loaded sample data</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="border-t border-white/[0.07] px-4 py-5">
          ...
          {isDemo && (
            <p className="mt-3 text-center text-[10px] text-slate-500">
              Demo session — data resets on reload
            </p>
          )}
          ...
          <button
            onClick={logout}
            className="mt-4 w-full flex items-center gap-2 rounded-xl px-3 py-2.5 text-[13px] font-medium text-slate-400
                       hover:bg-white/[0.045] hover:text-slate-100 transition-colors cursor-pointer"
          >
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <header className="flex shrink-0 items-center border-b border-white/[0.07] px-4 py-2.5 lg:p-0">
          ...
          {/* Demo badge in top bar (desktop) */}
          {!isMobile && isDemo && (
            <div className="ml-4 flex items-center gap-1.5 rounded-full bg-amber-500/10 border border-amber-500/30 px-3 py-1">
