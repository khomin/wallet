...
func (t *TokenPrice) ToGrpc() *pricev1.Price {
	return &pricev1.Price{
		...
		High_24H:                      t.High_24h,
		Low_24H:                       t.Low_24h,
		PriceChange_24H:               t.PriceChange_24h,
		PriceChangePercentage_24H:     t.PriceChangePercentage_24h,
		MarketCapChange_24H:           t.MarketCapChange_24h,
		MarketCapChangePercentage_24H: t.MarketCapChange_percentage_24h,
