...
const file_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x12user/v1/user.proto\x12\auser.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/api/annotations.proto\"\x17\n" +
	"\x15GetCurrentUserRequest\"<\n" +
	"\x16GetCurrentUserResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name2k\n" +
	"\vUserService\x12\\\n" +
	"\aGetUser\x12\x1e.user.v1.GetCurrentUserRequest\x1a\x1f.user.v1.GetCurrentUserResponse\"\x10\x82\xd3\xe4\x93\x02\n" +
...
var file_user_v1_user_proto_depIdxs = []int32{
	0, // 0: user.v1.UserService.GetUser:input_type -> user.v1.GetCurrentUserRequest
	1, // 1: user.v1.UserService.GetUser:output_type -> user.v1.GetCurrentUserResponse
