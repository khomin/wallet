...
export type Token = Message<"price.v1.Token"> & {
  ...
  /**
   * @generated from field: repeated price.v1.Chain chains = 4;
   */
  chains: Chain[];
...
/**
 * @generated from message price.v1.Chain
 */
export type Chain = Message<"price.v1.Chain"> & {
  /**
   * @generated from field: string symbol = 1;
   */
  symbol: string;
